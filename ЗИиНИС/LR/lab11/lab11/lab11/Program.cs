...
namespace lab11
{
    ...
    {
//Пpи аpифметическом сжатии(кодиpовании) текст пpедставляется вещественными

 //числами в интеpвале от 0 до 1. По меpе анализа текста отобpажающий его интеpвал уменьшается, а количество битов для его пpедставления возpастает.

//Основная идея арифметического метода сжатия заключается в том, чтобы присваивать коды не
//отдельным символам, а их последовательностям.

        static void Main(string[] args)
        {
            {
                string word = "Шастовская";
