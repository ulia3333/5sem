...
namespace lab3
{
    public static class LW3
    {
        ...
        public static string createReport()
        {
            ...
            string report = "";
            report += "Base64 энтропия (Шеннон): " + base64ES + "\n";
            report += "Latin энтропия (Шеннон): " + latinES + "\n";
            report += "Base64 энтропия (Чартли): " + base64EC + "\n";
            report += "Latin энтропия (Чартли): " + latinEC + "\n";
            report += "Резервирование base64: " + (base64EC - base64ES) / base64EC * 100 + "%\n";
            report += "Резервирование latin: " + (latinEC - latinES) / latinEC * 100 + "%\n";
            return report;
        }
