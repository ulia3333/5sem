...
namespace NineLab
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (StreamReader stream = new StreamReader(@"D:\5sem\ЗИиНИС\LR\юля\Lab9\lab9\NineLaab\NineLaab\NineLaab\bin\Debug\net5.0\latin.txt", Encoding.Default))
            {
                string messagef;
            ...
            string blockofFIO = "Chagan Alina Leonidovna";
