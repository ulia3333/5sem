...
namespace NineLab
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (StreamReader stream = new StreamReader(@"C:\Users\Helen\Desktop\Защита\SecondLab\Litovski.txt", Encoding.Default))
            {
                string messagef;
            ...
            string blockofFIO = "Trophimchuk Mihail Vitalievich";
