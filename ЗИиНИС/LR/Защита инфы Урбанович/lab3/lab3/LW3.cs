...
namespace lab3
{
    public static class LW3
    {
        ...
        public static string createReport()
        {
            ...
            report += "Base64 энтропия (Хартли): " + base64EC + "\n";
            report += "Latin энтропия (Хартли): " + latinEC + "\n";
            report += "Избыточность base64: " + (base64EC - base64ES) / base64EC * 100 + "%\n";
            report += "Избыточность latin: " + (latinEC - latinES) / latinEC * 100 + "%\n";
            return report;
        }
