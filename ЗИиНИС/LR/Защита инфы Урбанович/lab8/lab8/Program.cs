...
namespace lab8
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string initialMessageBytes = "пес";
            ...
            str = "110011001101001111001011";
            Console.WriteLine("Битовая последовательность 'мул' в ASCII: " + str);
            Console.WriteLine();


            string[] initMessages = new string[] { "юлия", "гринцевич", "мультимиллионер", str };
