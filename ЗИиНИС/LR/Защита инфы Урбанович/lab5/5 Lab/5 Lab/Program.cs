...
namespace Lab
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Генирируемое сообщение 24 бит");

            int[] array_message = new int[24];
            ...
            int[] array_paritet_rows = new int[3];
            int flag = 0;
            ...
            int[] array_paritet_colums = new int[8];
         
            if ((array_message[0] + array_message[8]+ array_message[16]) % 2 == 0) { array_paritet_colums[0] = 0; }
            else { array_paritet_colums[0] = 1; }

            if ((array_message[1] + array_message[9] + array_message[17]) % 2 == 0) { array_paritet_colums[1] = 0; }
            else { array_paritet_colums[1] = 1; }

            if ((array_message[2] + array_message[10] + array_message[18]) % 2 == 0) { array_paritet_colums[2] = 0; }
            else { array_paritet_colums[2] = 1; }

            if ((array_message[3] + array_message[11] + array_message[19]) % 2 == 0) { array_paritet_colums[3] = 0; }
            else { array_paritet_colums[3] = 1; }

            if ((array_message[4] + array_message[12] + array_message[20]) % 2 == 0) { array_paritet_colums[4] = 0; }
            else { array_paritet_colums[4] = 1; }

            if ((array_message[5] + array_message[13] + array_message[21]) % 2 == 0) { array_paritet_colums[5] = 0; }
            else { array_paritet_colums[5] = 1; }

            if ((array_message[6] + array_message[14] + array_message[22]) % 2 == 0) { array_paritet_colums[6] = 0; }
            else { array_paritet_colums[6] = 1; }

            if ((array_message[7] + array_message[15] + array_message[23]) % 2 == 0) { array_paritet_colums[7] = 0; }
            ...
            int[] array_message_with_one_error = new int[24];
            array_message_with_one_error = array_message;
            int rand_index = rand.Next(0, 24);
            ...
            int[] array_paritet_rows_with_one_error = new int[3];
            ...
            for (int i = 0; i < array_message_with_one_error.Length; i++)
            {
                ...
                {
                    if (flag % 2 == 0) { array_paritet_rows_with_one_error[1] = 0; }
                    else { array_paritet_rows_with_one_error[2] = 1; }
                    flag = 0;
                }
            }
            ...
            int[] array_paritet_colums_with_one_error = new int[8];

            if ((array_message_with_one_error[0] + array_message_with_one_error[8]+ array_message_with_one_error[16]) % 2 == 0) { array_paritet_colums_with_one_error[0] = 0; }
            else { array_paritet_colums_with_one_error[0] = 1; }
            if ((array_message_with_one_error[1] + array_message_with_one_error[9] + array_message_with_one_error[17]) % 2 == 0) { array_paritet_colums_with_one_error[1] = 0; }
            else { array_paritet_colums_with_one_error[1] = 1; }
            if ((array_message_with_one_error[2] + array_message_with_one_error[10] + array_message_with_one_error[18]) % 2 == 0) { array_paritet_colums_with_one_error[2] = 0; }
            else { array_paritet_colums_with_one_error[2] = 1; }
            if ((array_message_with_one_error[3] + array_message_with_one_error[11] + array_message_with_one_error[19]) % 2 == 0) { array_paritet_colums_with_one_error[3] = 0; }
            else { array_paritet_colums_with_one_error[3] = 1; }
            if ((array_message_with_one_error[4] + array_message_with_one_error[12] + array_message_with_one_error[20]) % 2 == 0) { array_paritet_colums_with_one_error[4] = 0; }
            else { array_paritet_colums_with_one_error[4] = 1; }
            if ((array_message_with_one_error[5] + array_message_with_one_error[13] + array_message_with_one_error[21]) % 2 == 0) { array_paritet_colums_with_one_error[5] = 0; }
            else { array_paritet_colums_with_one_error[5] = 1; }
            if ((array_message_with_one_error[6] + array_message_with_one_error[14] + array_message_with_one_error[22]) % 2 == 0) { array_paritet_colums_with_one_error[6] = 0; }
            else { array_paritet_colums_with_one_error[6] = 1; }
            if ((array_message_with_one_error[7] + array_message_with_one_error[15] + array_message_with_one_error[23]) % 2 == 0) { array_paritet_colums_with_one_error[7] = 0; }
            ...
            Console.WriteLine('\n' + "-----");
            int[] rows_paritet_with_errors = new int[3];
            ...
            if ((array_paritet_rows[2] == 0 && array_paritet_rows_with_one_error[2] == 0) || (array_paritet_rows[2] == 1 && array_paritet_rows_with_one_error[2] == 1))
            {
                rows_paritet_with_errors[2] = 0;
            }
            else
            {
                rows_paritet_with_errors[2] = 1;
            }
            ...
            int[] colums_paritet_with_errors = new int[8];
