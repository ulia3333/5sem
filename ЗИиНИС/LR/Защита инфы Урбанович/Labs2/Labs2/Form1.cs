...
namespace labs2
{
    public partial class Form1 : Form
    {
        ...
        string Shifr = "JULIABCDEFGHKMNOPQRSTVWXYZ*/";
        string alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
        string alphabet2 = "RILKABCDEFGHJMNQTUVWXYZOSP";
        ...
        private void YES_TextChanged(object sender, EventArgs e)
        {
